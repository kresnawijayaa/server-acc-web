...
const { deleteAllCustomers, createCustomer, bulkCreateCustomer, getCustomers, getCustomer, updateCustomer, deleteCustomer, getNearbyCustomers } = require('../controllers/customerController');
...
router.delete('/', [verifyToken, isAdmin], deleteAllCustomers);
